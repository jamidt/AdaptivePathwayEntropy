...
fig_path_entropy.savefig("path_entropy_HoC_directed.pdf")
fig_endpoint_entropy.savefig("endpoint_entropy_HoC_directed.pdf")
fig_conditional_entropy.savefig("conditional_entropy_HoC_directed.pdf")
